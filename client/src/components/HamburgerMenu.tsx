...
const HamburgerMenu = () => {
  ...
  return (
    <>
      ...
      <div className={`menu transition-all fixed top-[61.2px] w-screen h-screen bg-white/40 dark:bg-[#0e0e10]/60 backdrop-blur z-50 px-6 pt-5 ease-out duration-300 ${isMenuOpen?'left-0':'left-[100vw]'}`}>
