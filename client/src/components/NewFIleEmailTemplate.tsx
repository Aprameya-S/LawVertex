...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <div className='max-w-[600px] mx-auto font-serif px-5 pt-[50px] '>
              ...
              <stop offset="1" stop-color="#1161FB"/>
                ...
                <br/>
                <br/><br/>
                You have received file <b>{fileName}</b> from <b>{"name"}</b> <i>[{fileOwner}]</i> to your lawvertex account linked to wallet <b>{receiverAddress}</b>.

                <br/>
                <br/>

                <p className='text-center text-[24px] tracking-[10px]'>{password}</p>
              ...
              File can be viewed at <a href={'lawvertex.vercel.app/vault/receivedFiles/${newpublicid}'}>{publicid}</a>
              <br/><br/><br/><br/>
              <p className='text-[12px] tracking-[0.24px] text-center text-[#646d7a]'>Copyright © Lawvertex</p>
              </div>
);
