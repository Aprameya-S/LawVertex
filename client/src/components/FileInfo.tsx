  ...
  return (
    <div className='border bg-secondary border-input relative rounded-xl p-6'>
      <div className="flex justify-between">
        <h1 className='font-semibold text-2xl grid grid-cols-[20px_1fr] items-bottom gap-2'>
          <Image
          src={fileIcon}
          alt="File Icon"
          width={20}
        ...
        <div className="flex gap-2">
          {
            file.encrypted && (
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" strokeLinejoin="round" className="lucide lucide-lock"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            )
          }
          {
            file.searchable ? (
